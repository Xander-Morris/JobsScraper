import { useMarkJobAppliedMutation, useUnmarkJobAppliedMutation } from '@/src/hooks/use-jobs'
import type { Job } from '@/src/api/schemas'
import { CircleCheckIcon } from 'lucide-react'
import { Button } from '../../ui/button'

export default function JobAppliedToggle({ job }: { job: Job }) {
  const markApplied = useMarkJobAppliedMutation()
  const unmarkApplied = useUnmarkJobAppliedMutation()
