...
function ApplyActionBar({
  ...
  generateContent: ReturnType<typeof useGenerateApplicationContentMutation>
  markApplied: ReturnType<typeof useMarkJobAppliedMutation>
  unmarkApplied: ReturnType<typeof useUnmarkJobAppliedMutation>
}) {
...
function GeneratedContentSection({ data }: { data: GeneratedContent }) {
  ...
  return (
    <Card className="mt-6">
      ...
      <CardContent className="space-y-3 text-sm">
        ...
        {generateContent.data && <GeneratedContentSection data={generateContent.data} />}
      </CardContent>
    </Card>
  )
}
